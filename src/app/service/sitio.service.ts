...
export class SitioService {
  ...
  agregarSitio(sitio: SitioI): Observable<any> {
    return this.httpClient.post<any>(`${AUTH_SERVER}/api/agregar-sitio/`, JSON.stringify(sitio), this.httpOptions)
    .pipe(catchError(this.handleError));
  }

  listarSitios(representanteId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/listar-sitios/${representanteId}`, this.httpOptions)
    .pipe(
  ...
  obtenerEstadoCuenta(sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/obtener-estado-cuenta/${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
  ...
  obtenerPagoDetalles(codigoId: number, sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/obtener-pago-detalles/${codigoId}&${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
  ...
  obtenerPagos(sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/obtener-pagos/${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
  ...
  obtenerDeudas(sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/obtener-deudas/${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
  ...
  obtenerSitio(sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/obtener-sitio/${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
