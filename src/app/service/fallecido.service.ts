...
export class FallecidoService {
  ...
  agregarFallecido(fallecido: FallecidoI): Observable<any> {
    return this.httpClient.post<any>(`${AUTH_SERVER}/api/agregar-fallecido/`, JSON.stringify(fallecido), this.httpOptions)
    .pipe(catchError(this.handleError));
  }

  listarFallecidosRepresentante(representanteId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/listar-fallecidos-representante/${representanteId}`, this.httpOptions)
    .pipe(
  ...
  listarFallecidos(sitioId: number): Observable<any> {
    return this.httpClient.get<any>(`${AUTH_SERVER}/api/listar-fallecidos/${sitioId}`, this.httpOptions)
    .pipe(
      catchError(this.handleError)
    );
  }
